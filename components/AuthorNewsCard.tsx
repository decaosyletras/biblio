...
export default function AuthorNewsCard({
  ...
  return (
    ...
    <Link
      ...
      className="block bg-zinc-900 border border-zinc-800 rounded-xl p-4 hover:border-yellow-500/40 hover:bg-zinc-800
                transition">
      ...
      <div className="flex gap-4">
        ...
        <div className="min-w-0">
          ...
          {item.news?.type && (
            <span
              className="inline-block mt-1 text-[11px] px-2 py-1 rounded-full bg-yellow-500/10 text-yellow-400"
            >
              {item.news.type}
            </span>
          )}
