export const genresCatalog = [
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "xenoficcion", label: "Xenoficción" },
      { id: "invasionalienigena", label: "Invasión Alienígena" },
      { id: "evolucionespeculativa", label: "Evolución Especulativa" },
      { id: "technothriller", label: "Techno thriller" },
    ],
  },
  {
    id: "romance",
    label: "Romance",
    subgenres: [
      { id: "amorprohibido", label: "Amor Prohibido" },
