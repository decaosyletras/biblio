...
export const books: Book[] = [
  ...
  { slug: "heraldos-de-la-muerte",
    ...
    subgenres: ["epica", "emotiva", "sobrenatural"],
  ...
  { slug: "historias-de-boston",
    ...
    subgenres: ["epica", "exploracionespacial", "realidadesalternas", "cosmico", "historica"],
  ...
  { slug: "el-futuro-que-escribimos-juntos",
    ...
    subgenres: ["amorprohibido", "THpsicologico"],
...
`,
  ...
  { slug: "cuando-dolia-memorias-de-una-mente-fragmentada",
    ...
    review: {
      ...
      excerpt: ``,
      content: "",
      metrics: ["pasadoorigenes", "saludmental"],
    },
    genre: ["noficcion"],
