...
export default async function AuthorPage({
    ...
    const authorTheme = {
        ...
        surface: themeConfig?.surface ?? "#323238",
        primary: themeConfig?.primary ?? "#1b53cb",
            ...
            <main className="max-w-5xl mx-auto px-3 sm:px-6 pt-6 pb-16 space-y-8">
                ...
                {isPro && author.news?.type && (
                    ...
                    >
                        ...
                        {author.news.title && (
                            <h3
                                className="text-3xl md:text-4xl font-black mb-5 text-center"
                                style={{
                                    color: authorTheme.text
                                }}
                            >
                        ...
                        <div>
                            <div className="mt-3 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                                <div>
                                    ...
                                    <h2
                                        className="text-2xl font-bold mb-6 md:mb-4"
                                        style={{
                                            color: authorTheme.text
                                        }}
                                    >
