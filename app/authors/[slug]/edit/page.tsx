                ...
                {!isPro && (
                    <div className="rounded-3xl bg-zinc-900 border border-yellow-500/30 p-5 space-y-5">
                        ...
                        <p className="text-xs text-yellow-500">
                            ✨ Prueba <strong>PRO</strong> con un <strong>50% de descuento</strong> usando el código <strong>LANZAMIENTO</strong>. Aprovecha la promoción y cancela en cualquier momento si no es para ti.
                        </p>
